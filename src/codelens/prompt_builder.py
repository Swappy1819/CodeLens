...
class PromptBuilder:
    ...
    def build(self, request: ReviewRequest) -> str:
        ...
        return (
            ...
            "- Symbols listed in Graph context are verified repository symbols.\n"
            "- The \"Verified callee source\" section contains authoritative source "
            "retrieved from the repository for those symbols.\n"
            "- Before reporting an undefined-function or undefined-symbol finding, "
            "check the Graph context and Verified callee source.\n"
            "- If the symbol appears there, it is defined and available in the "
            "repository. Do not report it as undefined.\n"
